...
if __name__ == "__main__":
    ...
    parser.add_argument('--repnworker', type=int, default=1)
    parser.add_argument('--clinworker', type=int, default=1)
    parser.add_argument('--repburst', type=int, default=1)
    parser.add_argument('--cliburst', type=int, default=1)
    ...
    print(len(replicas), keygen_bin, keys)
    ...
    print('block size is ', args.block_size)
